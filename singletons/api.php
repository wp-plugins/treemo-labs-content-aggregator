...
class JSON_API {
  ...
  function admin_menu() {
    add_options_page('Treemo Labs Content Aggregator Settings', 'Treemo Labs Content Aggregator', 'manage_options', 'treemo-labs-content-aggregator', array(&$this, 'admin_options'));
  }
...
<div class="wrap">
  ...
  <form action="options-general.php?page=treemo-labs-content-aggregator" method="post">
          ...
          <tr class="<?php echo ($active ? 'active' : 'inactive'); ?>">
            ...
            <td class="plugin-title">
              ...
              <div class="row-actions-visible">
                ...
                if ($active) {
                  echo '<a href="' . wp_nonce_url('options-general.php?page=treemo-labs-content-aggregator&amp;action=deactivate&amp;controller=' . $controller, 'update-options') . '" title="' . __('Deactivate this controller') . '" class="edit">' . __('Deactivate') . '</a>';
                } else if (!$error) {
                  echo '<a href="' . wp_nonce_url('options-general.php?page=treemo-labs-content-aggregator&amp;action=activate&amp;controller=' . $controller, 'update-options') . '" title="' . __('Activate this controller') . '" class="edit">' . __('Activate') . '</a>';
                }
